{{-- upload --}}
<h5 class="ml-md-2 mt-4" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">Upload Dokumen Penyampaian <i class="fas fa-caret-down"></i></h5>
...
<div class="collapse" id="collapseExample">
    @if ($getHarmonisasi->doc_penyampaian->docx1 == null && $getHarmonisasi->doc_penyampaian->docx2 == null && $getHarmonisasi->doc_penyampaian->docx3 == null && $getHarmonisasi->doc_penyampaian->docx4 == null && $getHarmonisasi->doc_penyampaian->docx5 == null)
    ...
    {{-- @if ($getHarmonisasi->doc_penyampaian->docx2)
        <div class="form-group col mt-4">
            <label>Na</label>
            <br>
            <a target="_blank" class="badge badge-info mr-3" href="{{ asset('storage') }}/{{ $getHarmonisasi->doc_penyampaian->docx2 }}" style="cursor: pointer;"><i class="fas fa-download"></i> Lihat Dokumen</a>
            <a class="badge badge-danger mt-2" href="/2/penyampaian/{{ $getHarmonisasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif


    @if ($getHarmonisasi->doc_penyampaian->docx3)
        <div class="form-group col mt-4">
            <label>SK</label>
            <br>
            <a target="_blank" class="badge badge-info mr-3" href="{{ asset('storage') }}/{{ $getHarmonisasi->doc_penyampaian->docx3 }}" style="cursor: pointer;"><i class="fas fa-download"></i> Lihat Dokumen</a>
            <a class="badge badge-danger mt-2" href="/3/penyampaian/{{ $getHarmonisasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif

    @if ($getHarmonisasi->doc_penyampaian->docx4)
        <div class="form-group col mt-4">
            <label>Draft RPERDA PEMDA</label>
            <br>
            <a target="_blank" class="badge badge-info mr-3" href="{{ asset('storage') }}/{{ $getHarmonisasi->doc_penyampaian->docx4 }}" style="cursor: pointer;"><i class="fas fa-download"></i> Lihat Dokumen</a>
            <a class="badge badge-danger mt-2" href="/4/penyampaian/{{ $getHarmonisasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif

    @if ($getHarmonisasi->doc_penyampaian->docx5)
        <div class="form-group col mt-4">
