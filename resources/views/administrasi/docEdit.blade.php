{{-- upload --}}
<h5 class="ml-md-2 mt-4" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">Upload Dokumen LPA/AK <i class="fas fa-caret-down"></i></h5>
...
<div class="collapse" id="collapseExample">
    @if ($getHarmonisasi->doc_administrasi->docx1 == null || $getHarmonisasi->doc_administrasi->docx2 || $getHarmonisasi->doc_administrasi->docx3 || $getHarmonisasi->doc_administrasi->docx4 || $getHarmonisasi->doc_administrasi->docx5)
    ...
    @if ($getHarmonisasi->doc_administrasi->docx1)
        <div class="form-group col mt-3">
            ...
            <a class="badge badge-danger mt-2" href="/1/{{ $getHarmonisasi->doc_administrasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif
    ...
    @if ($getHarmonisasi->doc_administrasi->docx2)
        <div class="form-group col mt-4">
            ...
            <a class="badge badge-danger mt-2" href="/2/{{ $getHarmonisasi->doc_administrasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif
    ...
    @if ($getHarmonisasi->doc_administrasi->docx3)
        <div class="form-group col mt-4">
            ...
            <a class="badge badge-danger mt-2" href="/3/{{ $getHarmonisasi->doc_administrasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif
    ...
    @if ($getHarmonisasi->doc_administrasi->docx4)
        <div class="form-group col mt-4">
            ...
            <a class="badge badge-danger mt-2" href="/4/{{ $getHarmonisasi->doc_administrasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif
    ...
    @if ($getHarmonisasi->doc_administrasi->docx5)
        <div class="form-group col mt-4">
            ...
            <a class="badge badge-danger mt-2" href="/5/{{ $getHarmonisasi->doc_administrasi->judul }}" style="cursor: pointer;"><i class="fas fa-trash"></i> Hapus Dokumen</a>
        </div>
    @endif
</div>