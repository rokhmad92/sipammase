                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-info" style="cursor: pointer;" data-toggle="modal"
                                                    data-target="#modal-edit{{ $item->id }}"><i class="fas fa-edit"></i>
                                                    Edit</span>
                                                <a href="/pendiri/{{ $item->id }}"
                                                    onclick="return confirm('Tunggu Fitur Selesai')"
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="namaRole"
                                name="nama" required autocomplete="off" value="{{ old('nama') }}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nip') is-invalid @enderror" id="nip"
                                name="nip" required autocomplete="off" value="{{ old('nip') }}">
                            @error('nip')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <form action="/pendiri/{{ $item->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="perancangEdit" name="nama" required autocomplete="off"
                                    value="{{ $item->nama }}">
                                @error('nama')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    id="nipedit" name="nip" required autocomplete="off"
                                    value="{{ $item->nip }}">
                                @error('nip')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                    id="jabatan" name="jabatan" required value="{{ $item->jabatan }}">
                                @error('jabatan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
